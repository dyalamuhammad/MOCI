...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: 0,
                filename: 'notulen_dt_l9.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
        ...
        $(document).ready(function() {
            ...
            $('.approve-btn').click(function() {
                ...
                if (confirm('Anda yakin ingin approve?')) {
                    ...
                    $.ajax({
                        url: '{{ route('approveDt9', ['id' => $circle->id]) }}',
                        method: 'POST',
                        headers: {
                ...
                <div class="card">
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" rows="2">{{ $problem }}</textarea>
                        </div>
                        <div class="mb-2">
                            <label for="">Solusi</label>
                            <textarea class="form-control" rows="2">{{ $solusi }}</textarea>
                        </div>
                        <div class="mb-2">
                            <label for="">Hasil</label>
                            <textarea class="form-control" rows="2">{{ $hasil }}</textarea>
                        </div>
                        <div class="mb-2">
                            <label for="">Benefit</label>
                            <textarea class="form-control" rows="2">{{ $benefit }}</textarea>
                        </div>
                        <div class="mb-2">
                            <label for="">Manfaat Non Finansial</label>
                            <textarea class="form-control" rows="2">{{ $manfaat }}</textarea>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentDt9') }}"
