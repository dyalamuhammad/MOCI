...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenDt2') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green d-flex justify-content-between">
                        ...
                        <div class="d-flex py-1">
                            <a href="{{ route('formAbsensiDt') }}" class="text-white">Langkah 1</a>
                            <p class="fs-6 mx-2 text-white">></p>
                            <a href="{{ route('formAbsensiDt3') }}" class="text-white">Langkah 3</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <table class="table table-bordered rounded-3">
                                    ...
                                    <tr>
                                        <td class="table-green-2">Apa Yang Dilihat (SEE)</td>
                                        <td>
                                            <textarea placeholder="Isi Disini..." name="see" class="form-control border-0"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-green-2">Apa Yang Didengar (HEAR)</td>
                                        <td>
                                            <textarea placeholder="Isi Disini..." name="hear" class="form-control border-0"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-green-2">Apa Yang Difikirkan (THINK)</td>
                                        <td>
                                            <textarea placeholder="Isi Disini..." name="think" class="form-control border-0"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-green-2">Apa Yang Dilakukan (DO)</td>
                                        <td>
                                            <textarea placeholder="Isi Disini..." name="do" class="form-control border-0"></textarea>
                                        </td>
                                    </tr>
                                    <tr class="bg-orange">
                                        <td class="text-wrap bg-orange">PAIN</td>
                                        <td class="bg-orange">
                                            <textarea placeholder="Isi Disini..." name="pain" class="form-control border-0 bg-orange"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-wrap table-green-2">GAIN</td>
                                        <td>
                                            <textarea placeholder="Isi Disini..." name="gain" class="form-control border-0"></textarea>
                                        </td>
                                    </tr>
