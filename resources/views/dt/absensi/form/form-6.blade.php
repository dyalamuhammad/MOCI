...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenDt6') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green d-flex justify-content-between">
                        <h1 class="fs-4 card-title text-white mt-1">Langkah 4<br> <span class="fw-light">Prototype</span>
                        </h1>
                        <div class="d-flex py-1">
                            <a href="{{ route('formAbsensiDt5') }}" class="text-white">Langkah 5</a>
                            <p class="fs-6 mx-2 text-white">></p>
                            <a href="{{ route('formAbsensiDt7') }}" class="text-white">Langkah 7</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img id="previewImage2" src="" alt=""
                                                        style="display: none;" class="w-100">
                                                    <label for="input-file-2" class="btn btn-light">Choose File</label>
                                                    <input type="file" class="form-control d-none"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img id="previewImage3" src="" alt=""
                                                        style="display: none;" class="w-100">
                                                    <label for="input-file-3" class="btn btn-light">Choose File</label>
                                                    <input type="file" class="form-control d-none"
                            ...
                            <div class="col-12 mb-3 border-1 border-primary">
                            ...
                            <div class="col-12 mb-3 border-1 border-primary">
                                ...
                                <input type="file" class="form-control" name="foto_3d">
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img id="previewImage4" src="" alt=""
                                                        style="display: none;" class="w-100">
                                                    <label for="input-file-4" class="btn btn-light">Choose File</label>
                                                    <input type="file" class="form-control d-none" name="foto_after[]"
                                                        id="input-file-4" onchange="previewFile(this, 'previewImage4')">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class=""><input type="hidden"
                                                ...
                                                <td class="text-center">
                                                    <img id="previewImage5" src="" alt=""
                                                        style="display: none;" class="w-100">
                                                    <label for="input-file-5" class="btn btn-light">Choose File</label>
                                                    <input type="file" class="form-control d-none" name="foto_after[]"
                                                        id="input-file-5" onchange="previewFile(this, 'previewImage5')">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class=""><input type="hidden"
                                                ...
                                                <td class="text-center">
                                                    <img id="previewImage6" src="" alt=""
                                                        style="display: none;" class="w-100">
                                                    <label for="input-file-6" class="btn btn-light">Choose File</label>
                                                    <input type="file" class="form-control d-none" name="foto_after[]"
                                                        id="input-file-6" onchange="previewFile(this, 'previewImage6')">
                                                </td>
                                            </tr>
                            ...
                            <div class="col-12 mb-3 border-1 border-primary">
                                <label for="nama">Upload Foto Improvement</label>
