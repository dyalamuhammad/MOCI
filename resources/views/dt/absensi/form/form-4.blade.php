...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenDt4') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green d-flex justify-content-between">
                        <h1 class="fs-4 card-title text-white mt-1">Langkah 2<br> <span class="fw-light">Define</span>
                        </h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                <label for="">Customer Needs</label>
                                <table class="table table-bordered border-light rounded-3 border-2">
                                    <tr>
                                        <th class="table-success">Pengguna</th>
                                        <th class="table-success">Kebutuhan</th>
                                        <th class="table-success">Insight</th>
                                    </tr>
                                    <tr class="machine">
                                        <td class="">
                                            <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5" name="pengguna"></textarea>
                                        </td>
                                        <td class="">
                                            <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5" name="kebutuhan"></textarea>
                                        </td>
                                        <td class="">
                                            <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5" name="insight"></textarea>
                                        </td>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea type="text" class="form-control" placeholder="Isi Disini..." name="problem" required></textarea>
                            </div>
