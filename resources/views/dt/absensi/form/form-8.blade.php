...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenDt8') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green d-flex justify-content-between">
                        ...
                        <div class="d-flex py-1">
                            ...
                            <a href="{{ route('formAbsensiDt9') }}" class="text-white">Project Overview</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <table class="table table-bordered border-light rounded-3 border-2">
                                    <tr>
                                        ...
                                        <th class="bg-green text-light">Poin/Persentase</th>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <table class="table table-bordered border-light rounded-3 border-2">
                                    <tr>
                                        <th class="bg-green text-light col-1">Item</th>
                                        <th class="bg-green text-light col-5">Pertanyaan</th>
                                        <th class="bg-green text-light col-6">Detail</th>
                                    </tr>
                                    <tr>
                                        <td class="table-success">Safety</td>
                                        <td>
                                            <textarea name="" class="form-control border-0" id="" cols="30" rows="2"
