                    ...
                    <div class="card-body p-1 p-md-3">
                        <div class="notulen">
                            <table class="table table-bordered border-dark w-100 border-3">
                                ...
                                <tr>
                                    <td colspan="3" class="text-center py-0 align-middle"><b>NQI</b></td>
                                </tr>
                                ...
                                <tr>
                                    {{-- <td colspan="4">p</td> --}}
                                    <td colspan="5" class="col-3">{{ $benefit }}</td>
                                </tr>
                                <tr>
                                    <th colspan="5">Manfaat Non-finansial</th>
                                </tr>
                                <tr>
                                    {{-- <td colspan="4">p</td> --}}
                                    <td colspan="5" class="col-3">{{ $manfaat }}</td>
                                </tr>
                                <tr>
                                    <th colspan="5">File Nqi</th>
                                </tr>
                                <tr>
                                    {{-- <td colspan="4">p</td> --}}
                                    <td>
                                        <a href="{{ route('lihatFile', ['nama_file' => $fileNqi]) }}" target="_blank"
                                            class="btn btn-outline-primary">Lihat File</a>
                                    </td>
                                    <td colspan="4" class="col-3">{{ $fileNqi }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
