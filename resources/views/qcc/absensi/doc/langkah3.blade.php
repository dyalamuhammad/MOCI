    ...
    @section('script')
        ...
        <script>
            function downloadPDF2() {
                ...
                const opt = {
                    margin: [0.4, 0.2],
                    filename: 'notulen_qcc_l3.pdf', // Nama file PDF yang diunduh
                    image: {
                        type: 'jpeg',
                        quality: 1
                    },
            ...
            $(document).ready(function() {
                ...
                $('.approve-btn').click(function() {
                    ...
                    if (confirm('Anda yakin ingin approve?')) {
                        ...
                        $.ajax({
                            url: '{{ route('approveQcc3', ['id' => $circle->id]) }}',
                            method: 'POST',
                            headers: {
                ...
                <div class="row">
                    <div class="card">
                        ...
                        <div class="card-body p-1 p-md-3">
                            ...
                            <div
                                class="d-flex justify-content-between border border-dark border-start-0 border-end-0 mb-2 p-2">
                                <h4 class="my-auto">NOTULEN QCC</h4>
                                <h6 class="text-end text-dark my-auto">LANGKAH 3 - ANALISA MASALAH</h6>
                            </div>
                            <div class="mb-2 ">
                            ...
                            <div class="mb-2 ">
                                <label for="nama">Analisa 4M1E</label>
                                <table class="table table-borderless">
                                    <tr>
                                        <th class="col-1 bg-green text-light">ITEM</th>
                                        <th class="bg-green text-light">WHY 1</th>
                                        <th class="bg-green text-light">WHY 2</th>
                                        <th class="bg-green text-light">WHY 3</th>
                                        <th class="bg-green text-light">WHY 4</th>
                                        <th class="bg-green text-light">WHY 5</th>
                                        <th class="col-1 bg-green text-light">FOTO</th>
                                    </tr>
                                    @foreach ($analisa4m1es as $analisa)
                                        <tr class="table-success">
                                            <td class="text-capitalize">{{ $analisa->category }}</td>
                                            <td>{{ $analisa->why1 ?: '-' }}</td>
                                            <td>{{ $analisa->why2 ?: '-' }}</td>
                                            <td>{{ $analisa->why3 ?: '-' }}</td>
                                            <td>{{ $analisa->why4 ?: '-' }}</td>
                                            ...
                                            <td>
                                                @if ($analisa->foto)
                                                    <img src="{{ asset('notulen3/' . $analisa->foto) }}" alt="Foto"
                                                        class="w-100">
                                                @else
                                                    -
                                                @endif
                            ...
                            <div class="mb-2 ">
                                ...
                                <table class="table table-borderless">
                                    <tr>
                                        <th class="bg-green text-light">Akar Masalah</th>
                                        <th class="bg-green text-light">Standar</th>
                                        <th class="bg-green text-light">Metode Validasi</th>
                                        <th class="bg-green text-light">Actual</th>
                                        <th class="bg-green text-light">Judge</th>
                                    </tr>
                        ...
                        @if (auth()->user()->jabatan == 'FRM')
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <button class="btn btn-outline-primary col-4 col-lg-auto text-center my-3 mb-md-3 px-2"
                                    ...
                                    data-id="{{ $circle->id }}"><i
                                        class="bi
                                bi-check-circle me-2"></i>Approve
                                    With
                                    Comment</button>
                            </div>
                        @endif
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST" action="{{ route('approveCommentQcc3') }}"
