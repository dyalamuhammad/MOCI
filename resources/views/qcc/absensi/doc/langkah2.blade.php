                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="notulen">
                            <table class="table table-bordered border-dark w-100 border-3">
                                ...
                                <tr>
                                    <td colspan="3" class="text-center py-0 align-middle"><b>LANGKAH 2 MENETAPKAN
                                            TARGET</b></td>
                                </tr>
                                ...
                                @endforeach
                                <tr>
                                    <th colspan="5">Target Aspek Mutu</th>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <table class="table">
                                            ...
                                            @foreach ($aspekMutus as $aspekMutu)
                                                <tr>
                                                    <td class="bg-green col-5">{{ $aspekMutu->category }}</td>
                                                    <td>{{ $aspekMutu->detail ?: '-' }}</td>
                                                </tr>
                                            @endforeach
                                        </table>
                                ...
                                <tr>
                                    <th colspan="5">Target SMART + C</th>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <table class="table">
                                            ...
                                            @foreach ($smartCs as $smartC)
                                                <tr>
                                                    <td class="bg-green col-5">{{ $smartC->category }}</td>
                                                    <td>{{ $smartC->detail ?: '-' }}</td>
                                                </tr>
                                            @endforeach
                                        </table>
                                ...
                                <tr>
                                    <th colspan="5">Dampak Positif & Harapan</th>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <table class="table">
                                            ...
                                            @foreach ($dampaks as $dampak)
                                                <tr>
                                                    <td class="bg-green col-5">{{ $dampak->category }}</td>
                                                    <td>{{ $dampak->detail ?: '-' }}</td>
                                                </tr>
                                            @endforeach
                                        </table>
