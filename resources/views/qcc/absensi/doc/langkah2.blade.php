...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: [0.4, 0.2],
                filename: 'notulen_qcc_l2.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
        ...
        $(document).ready(function() {
            ...
            $('.approve-btn').click(function() {
                ...
                if (confirm('Anda yakin ingin approve?')) {
                    ...
                    $.ajax({
                        url: '{{ route('approveQcc2', ['id' => $circle->id]) }}',
                        method: 'POST',
                        headers: {
                ...
                <div class="card">
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="d-flex justify-content-between border border-dark border-start-0 border-end-0 mb-2 p-2">
                            ...
                            <h6 class="text-end text-dark my-auto">LANGKAH 2 - MENETAPKAN TARGET</h6>
                        </div>
                        <div class="mb-2 ">
                        ...
                        <div class="mb-2 ">
                            <label for="nama">Target Aspek Mutu</label>
                            <table class="table table-borderless">
                                <tr>
                                    <th class="col-2 bg-green text-light fs-7">Item</th>
                                    <th class="col-6 bg-green text-light fs-7">Detail</th>
                                </tr>
                                @foreach ($aspekMutus as $aspekMutu)
                                    <tr class="table-success">
                                        <td class="fs-7">{{ $aspekMutu->category }}</td>
                                        <td class="fs-7">{{ $aspekMutu->detail ?: '-' }}</td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="mb-2 ">
                            <label for="nama">Target SMART + C</label>
                            <table class="table table-borderless">
                                <tr>
                                    <th class="col-2 bg-green text-light fs-7">Item</th>
                                    <th class="col-6 bg-green text-light fs-7">Detail</th>
                                </tr>
                                @foreach ($smartCs as $smartC)
                                    <tr class="table-success">
                                        <td class="fs-7">{{ $smartC->category }}</td>
                                        <td class="fs-7">{{ $smartC->detail ?: '-' }}</td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="mb-2 ">
                            <label for="nama">Dampak Positif dan Harapan</label>
                            <table class="table table-borderless">
                                <tr>
                                    <th class="col-2 bg-green text-light fs-7">Item</th>
                                    <th class="col-6 bg-green text-light fs-7">Detail</th>
                                ...
                                @foreach ($dampaks as $dampak)
                                    <tr class="table-success">
                                        <td class="fs-7">{{ $dampak->category }}</td>
                                        <td class="fs-7">{{ $dampak->detail ?: '-' }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentQcc2') }}"
