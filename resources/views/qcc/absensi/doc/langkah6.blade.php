...
@section('script')
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: [0.4, 0.2],
                filename: 'notulen_qcc_l6.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
        ...
        $(document).ready(function() {
            ...
            $('.approve-btn').click(function() {
                ...
                if (confirm('Anda yakin ingin approve?')) {
                    ...
                    $.ajax({
                        url: '{{ route('approveQcc6', ['id' => $circle->id]) }}',
                        method: 'POST',
                        headers: {
                ...
                <div class="card">
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="d-flex justify-content-between border border-dark border-start-0 border-end-0 mb-2 p-2">
                            ...
                            <h6 class="text-end text-dark my-auto">LANGKAH 6 - EVALUASI HASIL</h6>
                        </div>
                        <div class="mb-2 ">
                        ...
                        <div class="mb-2 ">
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    <th class="bg-green text-light">SAFETY</th>
                                    <th class="bg-green text-light">COST</th>
                                    <th class="bg-green text-light">QUALITY</th>
                                    <th class="bg-green text-light">DELIVERY</th>
                                    <th class="bg-green text-light">MORAL</th>
                                    <th class="bg-green text-light">ENVIRONMENT</th>
                                </tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentQcc6') }}"
