...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: [0.4, 0.2],
                filename: 'notulen_qcc_l8.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
        ...
        $(document).ready(function() {
            ...
            $('.approve-btn').click(function() {
                ...
                if (confirm('Anda yakin ingin approve?')) {
                    ...
                    $.ajax({
                        url: '{{ route('approveQcc8', ['id' => $circle->id]) }}',
                        method: 'POST',
                        headers: {
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Notulen Langkah 8</h5>
                            </div>
                            <ul class="breadcrumb">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="d-flex justify-content-between border border-dark border-start-0 border-end-0 mb-2 p-2">
                            ...
                            <h6 class="text-end text-dark my-auto">LANGKAH 8 - RENCANA BERIKUT</h6>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    <th class="bg-green text-light col-6">Item</th>
                                    <th class="bg-green text-light">Target</th>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentQcc8') }}"
