        ...
        <div class="pcoded-content">
            ...
            @if ($periode->count() > 0)
                @php
                    ...
                    $npkLeaderExists = \App\Models\Circle::where('npk_leader', $npkUser)
                        ->where('periode', $periode)
                        ->exists();
                    // $circleExist = $npkLeaderExists::Where('periode', $periode)->get();
                @endphp
                @if (
                    $activePeriode &&
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="d-flex gap-3 mb-3">
                                                <div>
                                                    <button class="btn btn-green rounded-1"></button> : Sedang Berlangsung
                                                </div>
                                                <div>
                                        ...
                                        @foreach ($langkahData->skip(1)->take(8) as $langkah)
                                            ...
                                            <button onclick="window.location.href='{{ route($routeName) }}'"
                                                ...
                                                {{ $isDisabled ? 'disabled' : '' }} data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                data-bs-title="Tooltip on top">L{{ $loop->iteration }}</button>
                                        @endforeach
                                        @php
                    ...
                    @else
                        ...
                        <p>Anda belum registrasi circle untuk periode ini, Silahkan register terlebih dahulu...</p>
                    @endif
                @else
