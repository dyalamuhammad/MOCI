                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered rounded-3 border-2 table-why">
                                        <tr>
                                            <td class="table-success px-6">What</td>
                                            <td class="table-success px-6">How</td>
                                            <td class="table-success px-6">Why</td>
                                            <td class="table-success px-6">Where</td>
                                            <td class="table-success px-6">Who</td>
                                            <td class="table-success px-6">When</td>
                                            <td class="table-success px-6">How Much</td>
                                        </tr>
                                        <tr>
                                            <td class="">
                                                <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5" name="what[]"></textarea>
