    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('tambah-baris').addEventListener('click', function() {
                ...
                // Dapatkan tabel
                var table = document.querySelector('.table-why');
                ...
                var cellContent = [
                    ...
                    '<textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5" name="how_much[]"></textarea>',
                ];
...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulen5') }}" method="POST" class="" enctype="multipart/form-data">
                @csrf
                <div class="card card-primary">

                    <div class="card-header bg-green d-flex justify-content-between">
                        <h1 class="fs-5 card-title text-white mt-1">Langkah 5 <br> <span class="fw-light fs-4">Implementasi
                                Perbaikan</span> </h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                <label for="">Implementasi Perbaikan</label>
                                <div class="d-flex mb-3">
                                    <button id="tambah-baris" class="btn btn-outline-success">Tambah Baris</button>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-why">
                                        <tr>
                                            <td class="table-success px-6 fw-bold">What</td>
                                            <td class="table-success px-6 fw-bold">How</td>
                                            <td class="table-success px-6 fw-bold">Why</td>
                                            <td class="table-success px-6 fw-bold">Where</td>
                                            <td class="table-success px-6 fw-bold">Who</td>
                                            <td class="table-success px-6 fw-bold">When</td>
                                            <td class="table-success px-6 fw-bold">How Much</td>
                                        </tr>
                                        <tr>
                                            <td class="">
                                                <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5" name="what[]"></textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="file" class="form-control" name="foto_improve">
                            </div>
