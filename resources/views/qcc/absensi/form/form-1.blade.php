...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulen') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="d-flex gap-1">
                                    ...
                                    <input type="checkbox" class="btn-check" id="quality" autocomplete="off">
                                    <label class="btn btn-outline-success" for="quality">QUALITY</label><br>
                                ...
                                <table class="table table-bordered border-light rounded-3 border-2 table-responsive">
                                    <tr>
                                        <th class="table-green col-1 col-md-3 text-truncate">Key Performance Indicator
                                            (KPI)</th>
                                        <th class="table-green col-2 col-md-2">Sub Item</th>
                                    ...
                                    <tr class="quality" style="display: none;">
                                        <td class="table-green-2"><input type="hidden"
                                                class="form-control border-0 text-center" name="category[]"
                                    ...
                                    <tr class="product" style="display: none;">
                                        <td class="table-green-2"><input type="hidden"
                                                class="form-control border-0 text-center" name="category[]"
                                                value="PRODUCT" readonly />PRODUCT</td>
                                        <td class="table-green-2">Efisiensi Produksi</td>
                                        <td><input type="number" class="form-control border-0 text-center"
                                                placeholder="Isi disini..." name="target[]" /></td>
                                        <td><input type="number" class="form-control border-0 text-center"
                                                placeholder="Isi disini..." name="actual[]" /></td>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <table class="table table-bordered rounded-3">
                                    <tr>
                                        <th class="table-green col-auto">Tema Apa Yang dipilih</th>
                                        <th class="table-secondary col-7">Alasan</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{-- <input type="number" class="form-control border-0 text-center" placeholder="Isi disini..." name="judge[]"/> --}}
                                            <select class="form-select text-center" style="width: 100%;"
                                                name="nama_tema">
                                                <option value="">-- Pilih --</option>
                                        ...
                                        <td>
                                            <textarea placeholder="Isi Disini..." name="alasan" class="form-control"></textarea>
                                        </td>
                                    </tr>
