                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered border-light rounded-3 border-2 table-responsive">
                                    <tr>
                                        <th class="table-green col-3">Key Performance Indicator (KPI)</th>
                                        <th class="table-green col-3">Sub Item</th>
                                        <th class="col-2 table-secondary">Target</th>
                                        <th class="col-2 table-secondary">Actual</th>
                                        <th class="col-2 table-secondary">Judge</th>
                                    </tr>
