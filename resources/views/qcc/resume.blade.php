...
@section('content')
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <!-- [ breadcrumb ] end -->
            <!-- [ Main Content ] start -->
            @if ($periode->count() > 0 and $activePeriode)
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header bg-darkBlue text-white">
                                <h5 class="text-white">Monitoring Keaktifan Anggota</h5>
                                <span class="d-block m-t-5">Hallo sahabat berikut resume absensi anggota setiap
                                    circle</span>
                            </div>
                            <div class="card-body table-border-style">
                                <div class="d-flex justify-content-between gap-1 mb-3">
                                    <div class="">
                                        <button class="btn btn-outline-green w-100"
                                            onclick="exportTableToExcel('resume-qcc-table', 'resume-qcc-data')">Export</button>
                                    </div>
                                    ...
                                    <div class="d-flex gap-1 col-6">
                                        ...
                                        <form id="search-form" action="{{ route('resumeQcc') }}" method="GET"
                                            class="w-100">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-borderes rounded-3 table-hover" id="resume-qcc-table">

                                        <tr class="table-primary">
                                            <th>No</th>
                                            <th class="col-1">NPK</th>
                                            <th class="col-2">Nama</th>
                                            <th class="col-2">Circle</th>
                                            <th>L1</th>
                                            <th>L2</th>
                                            <th>L3</th>
                                            <th>L4</th>
                                        ...
                                        <div class="pagination justify-content-between">
                                            <ul class="pagination button w-100">
                                                ...
                                                <li class="mx-5 align-content-center me-1 ms-5">
                                                    Showing {{ $members->count() }} of {{ $totalDisplayedRows }}
                                                </li>
                                            </ul>
                                        </div>
                                    @endif
