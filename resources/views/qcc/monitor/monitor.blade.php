                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-border-style">
                                <div class="d-flex justify-content-between gap-1 mb-3">
                                    <div class="">
                                        <button class="btn btn-outline-green w-100"
                                            onclick="exportTableToExcel('qcc-table', 'qcc-data')">Export</button>
                                    </div>

                                    <div class="d-flex gap-1 col-6">
                                        <div class="dropdown">
                                            <button class="btn btn-light border-dark text-capitalize col-12 text-left"
                                        ...
                                        <form action="{{ route('monitorQcc') }}" method="GET" class="w-100"
                                            id="search-form">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="qcc-table">
                                        ...
                                        @foreach ($showCircle as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->leader }}</td>
                                                <td>@php
                                                    $org = \App\Models\Org::where('npk', $item->npk_leader)->first();
                                                    $deptName = $org
                                                ...
                                                <td>@php
                                                    $spvNpk = $org
                                                        ...
                                                        : 'Tidak ada section';
                                                    $spvName = \App\Models\User::where('npk', $spvNpk)->value('name');
                                                    echo $spvName;
                                                @endphp</td>
                                                <td>@php
                                                    $frmNpk = $org
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-sm btn-green"
                                                        onclick="window.location='{{ route('detailCircle', ['circle_id' => $item->id]) }}'"
                                        ...
                                        <div class="pagination justify-content-between">
                                            <ul class="pagination button w-100">
                                                ...
                                                <li class="mx-5 align-content-center me-1 ms-5">
                                                    Showing {{ $showCircle->count() }} of {{ $showCircle->total() }}
                                                </li>
                                            </ul>
                                        </div>
                                    @endif
