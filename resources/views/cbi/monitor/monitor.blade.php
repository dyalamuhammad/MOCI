                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Monitor CBI</h5>
                            </div>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body table-border-style">
                                            <div class="d-flex justify-content-between gap-1 mb-3">
                                                <div class="">
                                                    <button class="btn btn-outline-green w-100"
                                                        onclick="exportTableToExcel('cbi-table', 'cbi-data')">Export</button>
                                                </div>
                                                <div class="d-flex gap-1 col-6">
                                                    ...
                                                    <form action="{{ route('monitorCbi') }}" method="GET" class="w-100"
                                                        id="search-form">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table" id="cbi-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <button class="btn btn-sm btn-green"
                                                                    onclick="window.location='{{ route('detailCircleCbi', ['circle_id' => $item->id]) }}'"
