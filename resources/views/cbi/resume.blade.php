                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Resume Absensi CBI</h5>
                            </div>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body table-border-style">
                                            <div class="d-flex justify-content-between gap-1 mb-3">
                                                <div class="">
                                                    <button class="btn btn-outline-green w-100"
                                                        onclick="exportTableToExcel('resume-cbi-table', 'resume-cbi-data')">Export</button>
                                                </div>
                                                <div class="d-flex gap-1 col-6">
                                                    ...
                                                    <form action="{{ route('resumeCbi') }}" method="GET" class="w-100"
                                                        id="search-form">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-borderes rounded-3" id="resume-cbi-table">
