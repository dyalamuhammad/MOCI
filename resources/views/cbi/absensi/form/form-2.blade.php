...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenCbi2') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green">

                        <h1 class="fs-4 card-title text-white mt-1">Langkah 2 - Empathy<br> <span class="fw-light">Empathy
                                Map</span>
                        </h1>
                    </div>
                    <div class="card-body">
