...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenCbi5') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                <label for="">Brainstorming IDE 8:3:5</label>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered border-light rounded-3 border-2">
                                        <thead>
                                            <tr>
                                                <th class="col-1"></th>
                                                <th class="bg-green text-light px-6">Ide 1</th>
                                                <th class="bg-green text-light px-6">Ide 2</th>
                                                <th class="bg-green text-light px-6">Ide 3</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tabel-body">
                                            <tr>
