...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenCbi7') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green">

                        <h1 class="fs-4 card-title text-white mt-1">Langkah 5<br> <span class="fw-light">5B. Customer
                                Feedback</span>
                        </h1>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="iterasi" style="display: none;">
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <div class="d-flex mb-3">
                                            <button type="button" id="tambah-kolom-2"
                                                class="btn btn-outline-success">Tambah
                                                Step</button>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered border-light rounded-3 border-2">
                                                ...
                                                <tbody id="tabel-body-2">
                                                    ...
                                                    <tr>
                                                        <td class=""><input type="hidden"
                                                                class="form-control border-0 text-center"
                                                                name="step_after[]" value="step 2" readonly />
                                                            Step 2
                                                        </td>
                                                        <td class="">
                                                            <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5"
                                                    ...
                                                    <tr>
                                                        <td class=""><input type="hidden"
                                                                class="form-control border-0 text-center"
                                                                name="step_after[]" value="step 3" readonly />
                                                            Step 3
                                                        </td>
                                                        <td class="">
                                                            <textarea type="text" class="form-control border-0" placeholder="Isi Disini..." rows="5"
