...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <form action="{{ route('addNotulenCbi9') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    <div class="card-header bg-green">

                        <h1 class="fs-4 card-title text-white mt-1">Project Overview</span>
                        </h1>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="problem" class="form-control" rows="2" placeholder="Isi Disini..."></textarea>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="">Solusi</label>
                                <textarea name="solusi" class="form-control" rows="2" placeholder="Isi Disini..."></textarea>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="">Hasil</label>
                                <textarea name="hasil" class="form-control" rows="2" placeholder="Isi Disini..."></textarea>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="">Benefit Per Tahun (Harus Angka)</label>
                                <textarea name="benefit" id="benefit" class="form-control" rows="1" placeholder="Isi Disini..."></textarea>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="">Manfaat Non Finansial</label>
                                <textarea name="manfaat" class="form-control" rows="2" placeholder="Isi Disini..."></textarea>
                            </div>
