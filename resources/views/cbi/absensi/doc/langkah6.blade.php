...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: 0,
                filename: 'notulen_cbi_l6.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
            ...
            $('.approve-btn').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('approveCbi6', ['id' => $circle->id]) }}',
                            method: 'POST',
                            headers: {
    ...
    <!-- Pastikan Sweet Alert JavaScript sudah dimuat sebelumnya -->

    <script>
        // Menangani klik pada tombol approve
        document.addEventListener('DOMContentLoaded', function() {
            ...
            approveBtns.forEach(function(btn) {
                btn.addEventListener('click', function() {
                    ...
                    // Kirim permintaan AJAX ke backend untuk menyetujui circle dengan ID tertentu
                    // Di sini Anda dapat memanggil endpoint atau fungsi yang sesuai untuk menyetujui circle
                    // Setelah itu, tampilkan alert success menggunakan Sweet Alert

                    // Contoh alert sederhana menggunakan Sweet Alert
                    Swal.fire({
                        icon: 'success',
                        title: 'Approve Successful',
                        text: 'Circle has been approved successfully!',
                        showConfirmButton: false,
                        timer: 1500 // Waktu (ms) sebelum alert otomatis hilang
                    });
                });
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentCbi6') }}"
