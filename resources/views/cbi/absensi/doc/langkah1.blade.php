...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: 0,
                filename: 'notulen_cbi_l1.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
            ...
            $('.approve-btn').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('approveCbi1', ['id' => $circle->id]) }}',
                            method: 'POST',
                            headers: {
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="mb-2">
                            ...
                            <table class="table table-borderless">
                                <tr class="text-light">
                                    <th class="bg-green text-light fs-7">NAMA</th>
                                    <th class="bg-green text-light fs-7">USIA</th>
                                    <th class=" bg-green text-light fs-7">ASAL</th>
                                    <th class="bg-green text-light fs-7">MOTIVASI</th>
                                    <th class="bg-green text-light fs-7">APA YANG MEMBUAT FRUSTASI</th>
                                </tr>
                                <tr class="table-success">
                                    <td>{{ $namaPersona }}</td>
                                    <td>{{ $usiaPersona }}</td>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentCbi') }}"
