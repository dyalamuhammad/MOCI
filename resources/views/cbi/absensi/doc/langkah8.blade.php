...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: 0,
                filename: 'notulen_cbi_l8.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
            ...
            $('.approve-btn').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('approveCbi8', ['id' => $circle->id]) }}',
                            method: 'POST',
                            headers: {
                ...
                <div class="card">
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="d-flex justify-content-between border border-dark border-start-0 border-end-0 mb-2 p-2">
                            ...
                            <h6 class="text-end text-dark my-auto">LANGKAH 5 - TEST PERFORMANCE</h6>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="nama">Performance</label>
                            <table class="table table-borderless mb-2">
                                <tr class="text-light">
                                    <th class="bg-green text-light fs-7">Item</th>
                                ...
                                <tr class="table-success">
                                    <td>Customer Effort Index (CEI)</td>
                                    <td>{{ $cei }}</td>
                                </tr>
                                <tr class="table-success">
                                    <td>Net Promotor Score (NPS)</td>
                                    <td>{{ $nps }}</td>
                                </tr>
                            </table>
                            <table class="table table-borderless mb-2">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentCbi8') }}"
