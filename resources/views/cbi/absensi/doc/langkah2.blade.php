...
@section('script')
    ...
    <script>
        function downloadPDF2() {
            ...
            const opt = {
                margin: 0,
                filename: 'notulen_cbi_l2.pdf', // Nama file PDF yang diunduh
                image: {
                    type: 'jpeg',
                    quality: 1
                },
            ...
            $('.approve-btn').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('approveCbi2', ['id' => $circle->id]) }}',
                            method: 'POST',
                            headers: {
            ...
            <div class="row">
                <div class="card">
                    ...
                    <div class="card-body p-1 p-md-3">
                        ...
                        <div class="mb-2">
                            <label for="nama">Apa Yang Dilihat (see)</label>
                            <input type="text" class="form-control text-capitalize" name="circle_name"
                                value="{{ $see ?? '' }}" readonly>
                        </div>
                        <div class="mb-2">
                            <label for="nama">Apa Yang Didengar (hear)</label>
                            <input type="text" class="form-control text-capitalize" name="circle_name"
                                value="{{ $hear ?? '' }}" readonly>
                        </div>
                        <div class="mb-2">
                            <label for="nama">Apa Yang Difikirkan (think)</label>
                            <input type="text" class="form-control text-capitalize" name="circle_name"
                                value="{{ $think ?? '' }}" readonly>
                        </div>
                        <div class="mb-2">
                            <label for="nama">Apa Yang Dilakukan (do)</label>
                            <input type="text" class="form-control text-capitalize" name="circle_name"
                                value="{{ $do ?? '' }}" readonly>
                        </div>
                        <div class="mb-2">
                            <label for="nama">Pain</label>
                            <input type="text" class="form-control text-capitalize" name="circle_name"
                                value="{{ $pain ?? '' }}" readonly>
                        </div>
                        <div class="mb-2">
                            <label for="nama">Gain</label>
                            <input type="text" class="form-control text-capitalize" name="circle_name"
                                value="{{ $gain ?? '' }}" readonly>
                        </div>
                        @if ($comment)
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('approveCommentCbi2') }}"
