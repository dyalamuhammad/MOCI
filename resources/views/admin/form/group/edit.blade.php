                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('karyawan') }}">Data Group</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('form') }}">Form Edit Group</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            </div>
            <form action="{{ route('update-group', $forms['id'] ?? null) }}" method="post" class=""
                        ...
                        <div class="row justify-content-end p-3">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="id_section" required>
                                    <option value="{{ $group->id_section }}" selected>{{ $sectionName }}</option>
