                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Control Group</h5>
                            </div>
                            <ul class="breadcrumb">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header bg-darkBlue text-white">
                            <h5 class="text-white">Data Group</h5>
                            <span class="d-block m-t-5">Hallo sahabat Berikut data group</span>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between gap-1 mb-3">
                                <div class="">
                                    <button class="btn btn-outline-green w-100"
                                        onclick="exportTableToExcel('group-table', 'group-data')">Export</button>

                                </div>
                                <div class="d-flex gap-1 col-3">

                                    <form action="{{ route('group') }}" method="GET" class="col-12">
                                        <div class="input-group">
                                            <input type="text" name="search" class="form-control"
                                                placeholder="Cari Nama atau ID Group" value="{{ $search }}">
                                ...
                                <div class="d-flex gap-1">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="{{ route('importGroup') }}"
                                                        ...
                                                        <p class="py-3"><a href="{{ route('downloadFormatGroup') }}"
                                    ...
                                    <button class="btn btn-primary"
                                        onclick="window.location.href='{{ route('form-group') }}'">ADD</button>
                                </div>


                            </div>
                            <div class="table-responsive">
                                <table class="table rounded-3" id="group-table">
