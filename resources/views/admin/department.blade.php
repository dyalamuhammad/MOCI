...
@section('script')
    <script>
        function doDelete(id) {
            if (confirm('Yakin Hapus Department?')) {
                // Menggunakan fungsi route() untuk mendapatkan URL dari nama rute Laravel
                var url = "{{ route('softDeleteDepartment', ':id') }}";
    ...
    <script>
        function exportTableToExcel(tableID, filename = '') {
            ...
            for (var i = 1; i < clonedTable.rows.length; i++) {
                ...
                var firstCell = clonedTable.rows[i].cells[0];
                if (firstCell) {
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Control Department</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="bi bi-house"></i></a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('department') }}">Data Department</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header bg-darkBlue text-white">
                            <h5 class="text-white">Data Department</h5>
                            <span class="d-block m-t-5">Hallo sahabat Berikut data department</span>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between gap-1 mb-3">
                                <div class="">
                                    <button class="btn btn-outline-green w-100"
                                        onclick="exportTableToExcel('dept-table', 'dept-data')">Export</button>

                                </div>
                                <div class="d-flex gap-1 col-3">

                                    <form action="{{ route('department') }}" method="GET" class="col-12">
                                        <div class="input-group">
                                            <input type="text" name="search" class="form-control col-12"
                                                placeholder="Cari Nama atau ID Department" value="{{ $search }}">
                                ...
                                <div class="d-flex gap-1">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="{{ route('importDept') }}"
                                                        ...
                                                        <p class="py-3"><a href="{{ route('downloadFormatDept') }}"
                                    ...
                                    <button class="btn btn-primary"
                                        onclick="window.location.href='{{ route('form-department') }}'">ADD</button>
                                </div>


                            </div>
                            <div class="table-responsive">
                                <table class="table rounded-3" id="dept-table">
                                    ...
                                    @foreach ($department as $item)
                                        <tr>
                                            ...
                                            <td class="text-center"><a class="btn btn-sm btn-green"
                                                    href="{{ route('edit-department', ['id' => $item->id]) }}">Detail</a>
