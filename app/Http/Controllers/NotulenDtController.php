...
class NotulenDtController extends Controller
{
    // ------ notulen 1 start ----
    public function add(Request $request) {
        ...
        $existingNotulen = NotulenDt1::where('circle_id', $request->circle_id)->exists();
        ...
        if ($existingNotulen) {
            ...
            return redirect()->route('absensiDt')
    ...
    public function storeorupdate(Request $request, $id = null) {
        $obj = $id === null ? new NotulenDt1() : NotulenDt1::find($id);
    ...
    public function add_2(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
            $existingNotulen = NotulenDt2::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_2(Request $request, $id = null) {
        $obj = $id === null ? new NotulenDt2() : NotulenDt2::find($id);
        $obj->circle_id = $request->circle_id;
        $obj->see = $request->see;
    ...
    public function add_3(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
        $existingNotulen = NotulenDt3::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_3(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt3() : NotulenDt3::find($id);
        $obj->circle_id = $request->circle_id;
        ...
        // Simpan setiap baris input ke dalam tabel NotulenDt3
    ...
    public function add_4(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
        $existingNotulen = NotulenDt4::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_4(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt4() : NotulenDt4::find($id);
        $obj->circle_id = $request->circle_id;
    ...
    public function add_5(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
        $existingNotulen = NotulenDt5::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_5(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt5() : NotulenDt5::find($id);
        $obj->circle_id = $request->circle_id;
    ...
    public function add_6(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
        $existingNotulen = NotulenDt6::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_6(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt6() : NotulenDt6::find($id);
        $obj->circle_id = $request->circle_id;
        ...
        foreach ($steps as $key => $step) {
            ...
            if (isset($fotos[$key])) {
                ...
                $imagePath = 'notulendt6/story-before/';
                $file->move(public_path($imagePath), $fileName);
                $filePath = 'notulendt6/story-before/' . $fileName;
        ...
        foreach ($steps as $key => $step) {
            ...
            if (isset($fotos[$key])) {
                ...
                $imagePath = 'notulendt6/story-after/';
                $file->move(public_path($imagePath), $fileName);
                $filePath = 'notulendt6/story-after/' . $fileName;
    ...
    public function add_7(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
        $existingNotulen = NotulenDt7::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_7(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt7() : NotulenDt7::find($id);
        $obj->circle_id = $request->circle_id;
        ...
        if (!empty($request->foto)){
                    ...
                    if ($request->foto) {
                        date_default_timezone_set('Asia/Jakarta');
                        $imageName = date('dmYHis') . '.' .$request->foto->extension();
                        $imagePath = 'iterasidt7/';
                        $request->foto->move(public_path($imagePath), $imageName);
                        $imgPath = 'iterasidt7/' . $imageName;
                    ...
                    // Buat entri baru dalam tabel StoryBeforeDt7
                    $storyBefore = new StoryBeforeDt7();
                    $storyBefore->id = $beforeId;
                    // Set nilai-nilai lainnya sesuai dengan kebutuhan
                    $storyBefore->circle_id = $request->circle_id;
                    ...
                    foreach ($steps as $key => $step) {
                        ...
                        if (isset($fotos[$key])) {
                            ...
                            $file = $fotos[$key];
                            $fileName = date('His') . $beforeId . '.' .$file->extension();
                            $imagePath = 'notulendt7/story-before/';
                            $file->move(public_path($imagePath), $fileName);
                            $filePath = 'notulendt7/story-before/' . $fileName;
                    ...
                    foreach ($steps as $key => $step) {
                        ...
                        if (isset($fotos[$key])) {
                            ...
                            $file = $fotos[$key];
                            $fileName = date('His') . $afterId . '.' .$file->extension();
                            $imagePath = 'notulendt7/story-after/';
                            $file->move(public_path($imagePath), $fileName);
                            $filePath = 'notulendt7/story-after/' . $fileName;
    ...
    public function add_8(Request $request) {
        ...
        $existingNotulen = NotulenDt8::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_8(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt8() : NotulenDt8::find($id);
        $obj->circle_id = $request->circle_id;
        $obj->csi = $request->csi;
        $obj->cei = $request->cei;
        $obj->nps = $request->nps;
    ...
    public function add_9(Request $request) {
        try {
            ...
            // Periksa apakah ada entri di tabel notulen1 dengan circle_id yang sama
        $existingNotulen = NotulenDt9::where('circle_id', $request->circle_id)->exists();
    ...
    public function storeorupdate_9(Request $request, $id = null) {
        ...
        $obj = $id === null ? new NotulenDt9() : NotulenDt9::find($id);
        $obj->circle_id = $request->circle_id;
        $obj->problem = $request->problem;
