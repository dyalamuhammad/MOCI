...
class AbsenController extends Controller
{
    ...
    if ($circle) {
        ...
        $nama_cord = $user_cord->name;
        return view('qcc.absensi.form.form-1', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'error', 'circleId', 'periodeId'));
    }
    ...
    if ($circle) {
        ...
        $langkah = Langkah::where('name', 'L1')->first(); // Mengambil langkah dengan nama L1
        ...
        return view('qcc.absensi.form.form-2', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'judul', 'periodeId'));
    }
    public function form3() {
        ...
        $langkah = Langkah::where('name', 'L2')->first(); // Mengambil langkah dengan nama L2
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-3', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
    public function form4() {
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-4', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
    public function form5() {
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-5', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
    public function form6() {
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-6', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
    public function form7() {
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-7', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
    public function form8() {
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-8', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
    public function form9() {
        ...
        $nama_cord = $user_cord->name;
        $judul = Notulen1::where('circle_id', $circleId)->value('judul');
        return view('qcc.absensi.form.form-9', compact('circles', 'circleName', 'leaderName', 'members', 'nama_cord', 'circleId', 'error', 'judul', 'periodeId'));
    }
