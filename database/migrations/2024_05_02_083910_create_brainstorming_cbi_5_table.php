...
return new class extends Migration
{
    ...
    {
        Schema::create('brainstorming_cbi_5', function (Blueprint $table) {
           $table->id();
            ...
            $table->foreign('notulen_id')->references('id')->on('notulen_cbi_5')->onDelete('cascade');
         });
    }
    ...
    {
        Schema::dropIfExists('brainstorming_cbi_5');
    }
};
